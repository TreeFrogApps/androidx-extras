...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("androidx-compose-material", "androidx.compose.material:material:1.4.1")
            library("androidx-compose-foundation", "androidx.compose.foundation:foundation:1.4.1")
            library("androidx-compose-runtime", "androidx.compose.runtime:runtime:1.4.1")
