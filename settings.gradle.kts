...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("androidx-activity-ktx", "androidx.activity:activity-ktx:1.7.1")
            library("androidx-core-ktx", "androidx.core:core-ktx:1.10.1")
            library("androidx-lifecycle-ktx", "androidx.lifecycle:lifecycle-runtime-ktx:2.6.1")
            library("androidx-workmanager-ktx", "androidx.work:work-runtime-ktx:2.8.1")
            library("androidx-window", "androidx.window:window:1.0.0")
            library("androidx-paging-runtime", "androidx.paging:paging-runtime:3.2.0-alpha05")
            ...
            library("androidx-compose-foundation", "androidx.compose.foundation:foundation:1.4.3")
            library("androidx-compose-runtime", "androidx.compose.runtime:runtime:1.4.3")
            library("androidx-paging-compose", "androidx.paging:paging-compose:1.0.0-alpha19")
